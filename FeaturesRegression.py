...
def main():
	...
	one_side_interactions_3 = zip(['product_description_lenght'] * 3, ['product_photos_qty_0', 'product_photos_qty_1', 'product_photos_qty_2'])
	...
	for feature, power in powers4:
		data = utils.polynomial_feature(data, feature, power)
	one_side_interactions_4 = zip(['product_weight_g'] * 3, ['product_length_cm', 'product_height_cm', 'product_width_cm'])
